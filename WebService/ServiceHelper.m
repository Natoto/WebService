...
/*
-(NSString*)syncServiceUrl:(NSString*)wsUrl nameSpace:(NSString*)nameSapce methodName:(NSString*)methodname soapMessage:(NSString*)soapMsg
{
    ASIHTTPRequest *request=[self commonServiceRequestUrl:wsUrl ServiceNameSpace:nameSapce ServiceMethodName:methodname SoapMessage:soapMsg];
    //设置同步
    [request startSynchronous];
    return [request responseString];
